...
I'm a frontend developer with a solid grasp of backend technologies too. My strengths include React, Bootstrap, Tailwind, FastAPI, Django, and MongoDB. I'm always open to discussing best practices or answering any questions—feel free to chat with me anytime!

- **Currently working with**: Python, React, Node.js, FastAPI
- **Open to collaborating on**: Full-stack projects, API development
- **Currently learning**:
Postgres, Data structures,  Django
